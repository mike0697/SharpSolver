...
val raccogli : normalized_polynomial -> normalized_polynomial
val controllaGradoEffettivo  : normalized_polynomial ->normalized_polynomial
val sempSolve3 : normalized_polynomial ->normalized_polynomial
val solve3 :  normalized_polynomial -> float
val ruffini : normalized_polynomial -> float -> normalized_polynomial 
